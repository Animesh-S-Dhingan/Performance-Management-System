    ...
    return (
        <Layout>
            <div style={{ marginBottom: '2rem' }}>
                ...
                <p style={{ color: 'var(--text-muted)' }}>Review and act on goal submissions from your direct reports.</p>
            </div>
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                        <thead>
                            <tr style={{ backgroundColor: '#f8fafc', borderBottom: '1px solid var(--border)', textAlign: 'left' }}>
                                ...
                                <th style={{ padding: '1rem', fontSize: '0.875rem', fontWeight: 600 }}>Weightage</th>
                        ...
                        <tbody>
                            {approvals.map(approval => (
                                <tr key={approval.id} style={{ borderBottom: '1px solid var(--border)' }}>
                                    ...
                                    <td style={{ padding: '1rem', fontSize: '0.875rem' }}>{approval.weightage}%</td>
                                    ...
                                    <td style={{ padding: '1rem' }}>
                                        <div style={{ display: 'flex', gap: '0.5rem' }}>
                                            ...
                                            <button className="btn" style={{ padding: '0.25rem 0.75rem', fontSize: '0.75rem', border: '1px solid var(--danger)', color: 'var(--danger)' }} onClick={() => handleAction(approval.id, 'reject')}>Reject</button>
                                        </div>
                                    </td>
                                </tr>
                            ))}
